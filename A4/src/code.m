...
for j = 1:(IMAGES-1)
    ...
    %%%%%%%%% CONFIG
    % swap the comment between the two lines below to use auto or manual 
    ...
    % do the transforms
    im_t = imtransform(im, T, 'XData', x_data, 'YData', y_data);
    result = imtransform(result, I, 'XData', x_data, 'YData', y_data);
